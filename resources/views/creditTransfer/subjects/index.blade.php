          ...
          <div class="table-responsive">
            ...
            <table id="example" class="table key-buttons text-md-nowrap">
              ...
              @else
                <thead>
                  <tr>
                    <th class="border-bottom-0">English Name {{ count($subjects) }}</th>
                    ...
                    <th colspan="2" class="border-bottom-0 text-center">Action</th>
                  </tr>
                </thead>
                <tbody>
                  @foreach ($subjects as $subject)
                    <tr>
                      ...
                      <td>
                        ...
                        {{-- <a href="{{ route('subject.destroy', $subject->id) }}" class="btn btn-danger"></i> <i class="fa-solid fa-trash"></i>Delete</a> --}}
                      </td>
                    </tr>
                  @endforeach
                </tbody>
